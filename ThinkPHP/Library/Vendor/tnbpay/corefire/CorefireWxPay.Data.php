	...
	**/
	public function ToXml()
	{
		if(!is_array($this->values) 
			|| count($this->values) <= 0)
		{
    		throw new CorefireWxPayException("数组数据异常！");
    	}
	...
	{	
		if(!$xml){
			throw new CorefireWxPayException("xml数据异常！");
		}
        //将XML转为array
        //禁止引用外部xml实体
 ...
 *
 */
class CorefireWxPayResults extends CorefireWxPayDataBase
{
	/**
	 * 
	 * 检测签名
	...
	public function CheckSign()
	{
		//fix异常
		if(!$this->IsSignSet()){
			throw new CorefireWxPayException("签名错误！");
		}
 ...
 *
 */
class CorefireWxPayNotifyReply extends  CorefireWxPayDataBase
{
	/**
	 * 设置接口版本
	 * @param string $value
 ...
 *
 */
class CorefireWxPayUnifiedOrder extends CorefireWxPayDataBase
{
	...
	**/
	...
	/**
	* 设置APP和网页支付提交用户端ip，Native支付填调用支付API的机器IP。
	* @param string $value 
	**/
	...
	/**
	* 获取APP和网页支付提交用户端ip，Native支付填调用支付API的机器IP。的值
	* @return 值
	**/
	...
	/**
	* 判断APP和网页支付提交用户端ip，Native支付填调用支付API的机器IP。是否存在
	* @return true 或 false
	**/
 ...
 *
 */
class CorefireWxPayJsWapOrder extends CorefireWxPayDataBase
{
    /**
     * 设置接口版本
     * @param string $value
 ...
 *
 */
class CorefireWxPayCloseOrder extends CorefireWxPayDataBase
{
	/**
	 * 设置接口版本
	 * @param string $value
 ...
 *
 */
class CorefireWxPayOrderQuery extends CorefireWxPayDataBase
{
	/**
	 * 设置接口版本
	 * @param string $value
 ...
 *
 */
class CorefireWxPayRefundOrder extends CorefireWxPayDataBase
{
    /**
     * 设置接口版本
     * @param string $value
     ...
     * @return 值
     **/
    public function 商户appid()
    {
        return $this->values['appid'];
    }
    /**
     * 判断微信支付分配的商户appid是否存在
     * @return true 或 false
     **/
    public function IsAppidSet()
    {
