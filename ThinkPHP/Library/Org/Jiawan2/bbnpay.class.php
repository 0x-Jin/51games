...
class jw_bbnpay{
    ...
    private $appKey     = "772a98a90bc0505abf87fc4472f74164";                       //* appkey
    private $appid      = "5300201803194355";                                       //* appid
    private $pcuserid   = "16711194@qq.com";                                        //* 用户在商户应用的唯一标识 一般为用户名或用户ID
    private $goodid     = 8529;                                                     //* 商品ID
    private $notifyUrl  = "http://apisdk.chuangyunet.net/Api/Reply/ChannelCallback/CyChannelId/27/CyChannelVer/2/PayType/2"; //* 支付回调通知地址
