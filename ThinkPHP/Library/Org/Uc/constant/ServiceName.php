...
class ServiceName {
     ...
     * 查询玩家是否已实名制接口前缀
     */
    public static $CP_REALNAME_PREFIX = "ng/cp/";
     ...
     * 智能域名系统的请求报文(参数指定)
     */
    public static $DOMAINSERVER_REALNAME_BODY = "1|sdknc.9game.cn";
     ...
     * 增加实名制查询接口
     */
    public static $GET_REALNAME_STATUS = "account.getRealNameStatus";
