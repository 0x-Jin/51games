...
class OrderModel extends Model
{
    ...
    {
        return M($this->tableName, C("DB_PREFIX_API"),'CySlave')->where($map)->force('createTime')->count();
    }
    ...
    {
        return M($this->tableName, C("DB_PREFIX_API"),'CySlave')->where($map)->force('createTime')->sum('amount');
    }
