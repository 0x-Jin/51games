...
class RuiwanModel extends SdkModel
{
    ...
    public function loginCheck($data)
    {
        ...
        //生成字符串
        $str    = "gameAppkey=".$key["AppKey"]."&userType=".$data["userType"]."&openId=".$data["uid"]."&timestamp=".$data["timestamp"];
    ...
    public function callbackCheck($data)
    {
        ...
        //进行签名验证
        $str    = "serverId=".$data["serverId"]."&playerId=".$data["playerId"]."&orderId=".$data["orderId"]."&gameAppKey=".$key["AppKey"];
        ...
        $res = array(
            ...
            "sandbox"   => $data["payType"] == "apple_sandbox"? "1": "0"                    //0：正式环境，1：沙箱环境
        );
