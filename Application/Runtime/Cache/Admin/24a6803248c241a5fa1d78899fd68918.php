    ...
    <body>
        ...
        <div class="container">
            <div class="row">
                ...
                <form action='<?php echo U("Data/payLtv");?>?table=sp_agent_server_pay_day' id="subfm" method="post">
...
<script type="text/javascript">
    $(function () {
        ...
        $('#echart').click(function(){
            ...
            $.post("<?php echo U('Data/payLtv');?>",_data+'&chart=1',function(ret){
...
columns = ltvArray();
store = Search.createStore('<?php echo U("Data/payLtv");?>?table=sp_agent_server_pay_day', {
        proxy: {
