    ...
    <body>
        ...
        <div class="container">
            <div class="row">
                ...
                <form action='<?php echo U("Data/agentPay");?>?table=sp_agent_server_pay_day' id="subfm" method="post">
...
store = Search.createStore('<?php echo U("Data/agentPay");?>?table=sp_agent_server_pay_day', {
        proxy: {
