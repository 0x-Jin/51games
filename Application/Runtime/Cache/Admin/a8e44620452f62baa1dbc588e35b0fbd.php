...
<div class="container">
    <div class="row">
        ...
        <form  method="post" action='<?php echo U("Data/actUser");?>' id="subfm"><input name="game_id" value="" type="hidden"><input name="agent" value="" type="hidden"><input name="agent_p" type="hidden" value="" ><input name="agentName" value="" type="hidden"><input name="serverId" value="" type="hidden"><input name="startDate" value="" type="hidden"><input name="endDate" value="" type="hidden"><input type="hidden" name="lookType" /><input type="hidden" name="export" value=1 /></form>
    </div>
...
x      })
    ...
    store = Search.createStore('<?php echo U("Data/actUser");?>', {
            proxy: {
