...
<div class="demo-content">
    ...
    <form id="J_Form" class="form-horizontal" method="post" style="height: 400px; overflow-y: auto; overflow-x: hidden;" action="<?php echo U('Game/updateAdd');?>">
        <div class="row">
        ...
        <div class="row">
            <div class="control-group span15">
                ...
                <div class="controls">
                    <input name="content" type="text" value="" style="width: 250px;" class="input-normal control-text">
                </div>
            </div>
        </div>
        <div class="row">
