...
<script type="text/javascript">
    ...
    function updateEdit(id, obj) {
        ...
        $(".mark").show();
        $(".spinner").show();
        $.get("<?php echo U('Game/updateEdit');?>", {id:id}, function(ret) {
    ...
    BUI.use("common/search", function (Search) {
        ...
        store = Search.createStore("<?php echo U('Game/update');?>",{
            proxy: {
        ...
        gridCfg = Search.createGridCfg(columns, {
            tbar: {
                items: [
                    ...
                    {text: "<i class='icon-plus'></i>批量新增渠道号更新", btnCls: "button button-small opt-btn", handler: agentFunction}
                ]
            },
        ...
        function addFunction() {
            ...
            $(".mark").show();
            $(".spinner").show();
            $.get("<?php echo U('Game/updateAdd');?>", "", function(ret) {
                $("#content").html(ret.Html);
                $("#content").show();
                $(".mark").hide();
                $(".spinner").hide();
        ...
        function agentFunction() {
            ...
            $(".mark").show();
            $(".spinner").show();
            $.get("<?php echo U('Game/updateAgent');?>", "", function(ret) {
                $("#content").html(ret.Html);
                $("#content").show();
                $(".mark").hide();
                $(".spinner").hide();
