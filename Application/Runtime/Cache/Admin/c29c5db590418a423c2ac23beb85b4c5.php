    ...
    <body>
        ...
        <div class="container">
            <div class="row">
                ...
                <form action='<?php echo U("Data/deviceRemain");?>' id="subfm" method="post">
...
<script type="text/javascript">
    function getChart(){
        ...
        $.post("<?php echo U('Data/deviceRemain');?>",_data+'&chart=1',function(ret){
    ...
    store = Search.createStore('<?php echo U("Data/deviceRemain");?>', {
            proxy: {
