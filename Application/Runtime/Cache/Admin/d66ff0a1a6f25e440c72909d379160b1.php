...
<html lang="zh-cn">
    ...
    function eventsEdit(id,obj){
        ...
        $('.spinner').show();
        if(!id) return false;
        $.get("<?php echo U('IOS/edit');?>",{table:'events',id:id,tpl:'fallEventsEdit'},function(ret){
    ...
    BUI.use('common/search',function (Search) {
        ...
        store = Search.createStore('<?php echo U("IOS/fallEvents");?>',{
          proxy : {
        ...
        gridCfg = Search.createGridCfg(columns,{
          tbar : {
            items : [
              {text : '<i class="icon-plus"></i>新建落地页推广活动',btnCls : 'button button-small opt-btn',handler:addFunction}
            ]
          },
      ...
      function addFunction(){
        ...
        $('.mark').show();
        $('.spinner').show();
        $.get('<?php echo U("IOS/add");?>',{table:'events',tpl:'fallEventsAdd'},function(ret){
          $('#content').html(ret._html);
          $('#content').show();
          $('.mark').hide();
          $('.spinner').hide();
