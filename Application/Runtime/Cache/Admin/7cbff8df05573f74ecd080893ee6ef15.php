    ...
    <body>
        ...
        <div class="container">
            <div class="row">
                ...
                <form action='<?php echo U("Data/newFirstPayRemain");?>' id="subfm" method="post">
            ...
            <div style="color:red;margin-left:10px;">
                当日注册付费帐户留存数据15分钟更新一次，留存数据每天更新一次
            </div>
        ...
        store = Search.createStore('<?php echo U("Data/newFirstPayRemain");?>', {
                proxy: {
