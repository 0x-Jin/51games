...
},beforePageText:"跳到",afterPageText:"共 {pages} 页",displayMsg:" 共 {total} 条记录"};
})(jQuery);
(function($){
function _92(_93){
var _94=$(_93);
...
$.fn.validatebox.defaults={required:false,validType:null,missingMessage:"必需字段",invalidMessage:null,rules:{email:{validator:function(_38b){
...
}).bind("keyup.combo",function(e){//edit by 2015-1-12
...
return new Date(testdt[0],testdt[1]-1,testdt[2],hour,_7be,_7bf);
}});
})(jQuery);
(function($){
function init(_7c0){
